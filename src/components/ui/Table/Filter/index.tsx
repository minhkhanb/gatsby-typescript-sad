...
const Filter: React.FunctionComponent<VehicleFilterProps> = ({
  totalCount,
  loading,
  onSubmitFilter,
  filter,
  ...
  const f = _.debounce((value: string) => {
  ...
  const handleOnChange = (_: React.ChangeEvent<HTMLInputElement>, { value }: InputOnChangeData) => {
    f(value);
  };
